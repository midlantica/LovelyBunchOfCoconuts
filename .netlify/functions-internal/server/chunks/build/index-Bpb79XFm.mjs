...
import __nuxt_component_0$1 from './Icon-CtKeyU67.mjs';
import { u as useContentCache } from './useContentCache-DPBreZ7N.mjs';
import MarkdownIt from 'markdown-it';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { u as useContentFeed } from './useContentFeed-DJ4ZA0ll.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            `)}" data-v-0aeb0c56${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${(_a = getAboveHr(markdownContent.value)) != null ? _a : ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${(_b = getBelowHr(markdownContent.value)) != null ? _b : ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${(_c = markdownContent.value) != null ? _c : ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
...
//# sourceMappingURL=index-Bpb79XFm.mjs.map
