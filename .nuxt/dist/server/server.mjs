...
import destr from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs";
import { withBase, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs";
import { toRouteMatcher, createRouter as createRouter$1 } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs";
import defu$1, { defu } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
import { useHead as useHead$1, headSymbol } from "/Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/@unhead+vue@2.0.11_vue@3.5.17_typescript@5.8.3_/node_modules/@unhead/vue/dist/index.mjs";
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import("./_nuxt/multipart-parser-CFXtLXiP.js");
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-DzbsUTE5.js")
  },
  {
    name: "memes-slug",
    path: "/memes/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-BNmLGKHz.js")
  },
  {
    name: "claims-slug",
    path: "/claims/:slug(.*)*",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/_...slug_-VB8zOWA5.js")
  },
  {
    name: "quotes-slug",
    path: "/quotes/:slug(.*)*",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_...slug_-CzKWIxlc.js")
  }
];
...
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-oUdncCau.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-CNhvErMP.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-topIL8Sv.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-3dfn1eag.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-BOWSPjQ3.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-BCSdsXjf.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-BeBORM26.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-bs6VFVgM.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-3BKlw1yl.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-BkpUzy_g.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-Czd8ZMLe.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-DTr01boi.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-C9X_Bwdx.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-DgD6b52L.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-DWfccV36.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProsePre = defineAsyncComponent(() => import("./_nuxt/ProsePre-BmYh2UAe.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseScript = defineAsyncComponent(() => import("./_nuxt/ProseScript-CdlH5OIN.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-BkL0i22r.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-DZvxuurb.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-CloJqfBO.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-Cmeuuok6.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-3hU5OJcn.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-CB-uAuUM.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-BmLm-AMX.js").then((r2) => r2["default"] || r2.default || r2));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-DeLEKNDN.js").then((r2) => r2["default"] || r2.default || r2));
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/Icon-CT7HiOLN.js").then((r2) => r2["default"] || r2.default || r2));
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-BUXmuq5s.js").then((r2) => r2["default"] || r2.default || r2));
...
const layouts = {
  "content-detail": defineAsyncComponent(() => import("./_nuxt/content-detail-CBXDdiuL.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-PmhL1Dhl.js").then((m) => m.default || m)),
  home: defineAsyncComponent(() => import("./_nuxt/home-w8ArmWxj.js").then((m) => m.default || m))
};
