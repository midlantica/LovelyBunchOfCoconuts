import { v as vueExports, c as useNuxtApp, s as serverRenderer_cjs_prodExports } from "../server.mjs";
import { u as useAppConfig, r as resolveIconName } from "./config-DmdBDFMn.js";
...
const Icon = vueExports.defineComponent({
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  async setup(__props) {
    ...
    vueExports.watch(() => {
      ...
      if (!((_b = (_a = appConfig.nuxtIcon) == null ? void 0 : _a.iconifyApiOptions) == null ? void 0 : _b.url)) return;
      try {
    ...
    const isFetching = vueExports.ref(false);
    ...
    const iconKey = vueExports.computed(() => [resolvedIcon.value.provider, resolvedIcon.value.prefix, resolvedIcon.value.name].filter(Boolean).join(":"));
    ...
    const className = vueExports.computed(() => {
      var _a;
    ...
    vueExports.watch(iconName, loadIconComponent);
    !component.value && ([__temp, __restore] = vueExports.withAsyncContext(() => loadIconComponent()), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      if (isFetching.value) {
        _push(`<span${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({
          class: className.value,
          style: { width: sSize.value, height: sSize.value }
        }, _attrs))} data-v-04ea5630></span>`);
      } else if (icon.value) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(vueExports.unref(Icon), vueExports.mergeProps({
          icon: icon.value,
          class: className.value,
          width: sSize.value,
          height: sSize.value
        ...
        serverRenderer_cjs_prodExports.ssrRenderVNode(_push, vueExports.createVNode(vueExports.resolveDynamicComponent(component.value), vueExports.mergeProps({
          class: className.value,
          width: sSize.value,
          height: sSize.value
        }, _attrs), null), _parent);
        ...
        }, _attrs))} data-v-04ea5630>`);
        serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, () => {
          _push(`${serverRenderer_cjs_prodExports.ssrInterpolate(__props.name)}`);
        }, _push, _parent);
        _push(`</span>`);
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-icon@0.6.10_magicast@0.3.5_vite@6.3.5_@types+node@24.0.4_jiti@2.4.2_terser@5.43.1__955dd651aff02a89b3856c8914d724dc/node_modules/nuxt-icon/dist/runtime/Icon.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04ea5630"]]);
export {
  __nuxt_component_0 as default
};
//# sourceMappingURL=Icon-B_75CSgK.js.map
