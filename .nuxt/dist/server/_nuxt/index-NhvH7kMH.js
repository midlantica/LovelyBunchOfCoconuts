          ...
          if (_push2) {
            if (loading.value) {
              ...
              if (meme.value.image) {
                ...
                _push2(`<div class="py-4 text-red-400" data-v-ad87bf89${_scopeId}>🚨 Meme image not found!</div>`);
              }
              _push2(`</div>`);
            ...
            `)}" data-v-ad87bf89${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${getAboveHr(markdownContent.value) ?? ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${getBelowHr(markdownContent.value) ?? ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${markdownContent.value ?? ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
...
//# sourceMappingURL=index-NhvH7kMH.js.map
