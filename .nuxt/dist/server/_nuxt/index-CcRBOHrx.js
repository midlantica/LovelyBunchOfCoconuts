...
import { u as useContentCache } from "./useContentCache-DPBreZ7N.js";
import MarkdownIt from "markdown-it";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { u as useContentFeed } from "./useContentFeed-DJ4ZA0ll.js";
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (loading.value) {
              ...
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-red-500 text-center" data-v-7d0e1221${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(error.value)}</div>`);
            } else if (claim.value) {
              _push2(`<div class="flex flex-col flex-1 min-h-0" data-v-7d0e1221${_scopeId}><div class="pb-2" data-v-7d0e1221${_scopeId}><div class="prose-invert max-w-none prose prose-lg" data-v-7d0e1221${_scopeId}><div data-v-7d0e1221${_scopeId}>${markdownContent.value ?? ""}</div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            `)}" data-v-0aeb0c56${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${getAboveHr(markdownContent.value) ?? ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${getBelowHr(markdownContent.value) ?? ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-0aeb0c56${_scopeId}><div data-v-0aeb0c56${_scopeId}>${markdownContent.value ?? ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
                ...
                vueExports.createVNode("div", { class: "flex flex-col flex-1 justify-center items-center w-full h-full" }, [
                  vueExports.createVNode("div", {
                    ...
                    vueExports.createVNode("div", { style: { "width": "100%", "flex-shrink": "0", "display": "flex", "align-items": "flex-start", "justify-content": "center", "padding": "0", "margin": "0" } }, [
                      ...
                      }, null, 14, ["src", "alt"])) : vueExports.createCommentVNode("", true)
                    ]),
...
//# sourceMappingURL=index-CcRBOHrx.js.map
