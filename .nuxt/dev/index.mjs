...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createError, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/h3@1.15.3/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import path, { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/@vue+shared@3.5.17/node_modules/@vue/shared/dist/shared.cjs.js';
import { promises } from 'node:fs';
import matter from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/gray-matter@4.0.3/node_modules/gray-matter/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/vue-bundle-renderer@2.1.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/vue@3.5.17_typescript@5.8.3/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/ofetch@1.4.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/node-mock-http@1.0.1/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unstorage@1.16.0_db0@0.3.2_better-sqlite3@12.1.1__ioredis@5.6.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unstorage@1.16.0_db0@0.3.2_better-sqlite3@12.1.1__ioredis@5.6.1/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/youch-core@0.3.2/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/youch@4.1.0-beta.8/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/source-map@0.7.4/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/devalue@5.1.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/vue@3.5.17_typescript@5.8.3/node_modules/vue/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unhead@2.0.11/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unhead@2.0.11/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/unhead@2.0.11/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///Users/drew/Documents/_work/WakeUpNPC2/.pnpm-store/db0@0.3.2_better-sqlite3@12.1.1/node_modules/db0/dist/connectors/better-sqlite3.mjs';
...
const _Ju6KXSCoOekNMLgjiesnJ9qyEfeUXBU1wFPKwYMT0o = (function(nitro) {
...
const _OCWt46l9no15WUeJElmcJBI8CankSroqmRrn0Wp9o = (nitroApp) => {
...
const plugins = [
  _Ju6KXSCoOekNMLgjiesnJ9qyEfeUXBU1wFPKwYMT0o,
_OCWt46l9no15WUeJElmcJBI8CankSroqmRrn0Wp9o,
...
const _iHxTWv = eventHandler(async (event) => {
...
const _CXJps0 = eventHandler(async (event) => {
...
const _lazy_BD3gnd = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_BD3gnd, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _iHxTWv, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _CXJps0, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BD3gnd, lazy: true, middleware: false, method: undefined }
];
...
const contentItem = defineEventHandler(async (event) => {
  const { type, slug } = getQuery$1(event);
  if (!type || !slug) {
  ...
  try {
    ...
    const headings = lines.filter((line) => line.startsWith("##") || line.startsWith("# ")).map(
...
const contentItem$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: contentItem
});
...
async function parseMarkdownFile$1(filePath) {
  try {
    const content = await promises.readFile(filePath, "utf-8");
    const { data, content: bodyContent } = matter(content);
    const relativePath = filePath.replace(process.cwd(), "").replace("/content", "").replace(".md", "");
...
const content = defineEventHandler(async (event) => {
  const { type = "all" } = getQuery$1(event);
  try {
    const contentDir = path.join(process.cwd(), "content");
    const dirsToRead = [];
    ...
    const filePathsArrays = await Promise.all(
      dirsToRead.map((dir) => readDir$1(dir))
    );
    const filePaths = filePathsArrays.flat();
    const contentItems = await Promise.all(
      filePaths.map((filePath) => parseMarkdownFile$1(filePath))
    );
...
const content$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: content
});

const debug = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
const search$2 = defineEventHandler(async (event) => {
  const { query } = getQuery$1(event);
  if (!query) {
    return [];
  }
...
const search$3 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: search$2
});
...
const com_chrome_devtools_json$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: com_chrome_devtools_json
});
...
const wellKnown$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: wellKnown
});
