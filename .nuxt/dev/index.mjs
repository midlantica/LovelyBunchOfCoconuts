...
import { createStorage, prefixStorage } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/unstorage@1.16.0_db0@0.3.2_better-sqlite3@12.1.1__ioredis@5.6.1/node_modules/unstorage/dist/index.mjs';
...
import defu, { defuFn, defu as defu$1 } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
...
import { isAbsolute } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
...
const _Xyiq7RURKa4zLWvbq2HN9fCI2CmC3SKf7dKfe_AP84 = (function(nitro) {
...
const _qWCwvHZNu_T1Z7uceH9yhxAj33SpwIY7sBcuikeeav4 = (nitroApp) => {
...
const plugins = [
  _Xyiq7RURKa4zLWvbq2HN9fCI2CmC3SKf7dKfe_AP84,
_qWCwvHZNu_T1Z7uceH9yhxAj33SpwIY7sBcuikeeav4,
...
const _UITgJDMeta = null;

const _VkkVdwMeta = null;

const _862YuXMeta = null;

const _DApUBPMeta = null;

const _Id3UyKMeta = null;

const _0n3a19Meta = null;

const _vudxzGMeta = null;

const _XoLYtKMeta = null;

const _6kTiyWMeta = null;

const _SxA8c9Meta = null;

const _QSy2txMeta = null;

const _E76sggMeta = null;

const _9Jq1pzMeta = null;

const __SB7yHMeta = null;

const _UiybO9Meta = null;

const handlersMeta = [
  { route: "/api/content-item", method: undefined, meta: _UITgJDMeta },
{ route: "/api/content", method: undefined, meta: _VkkVdwMeta },
{ route: "/api/content/debug", method: undefined, meta: _862YuXMeta },
{ route: "/api/content/item", method: "get", meta: _DApUBPMeta },
{ route: "/api/content/search", method: undefined, meta: _Id3UyKMeta },
{ route: "/api/search", method: undefined, meta: _0n3a19Meta },
{ route: "/.well-known/appspecific/com.chrome.devtools.json", method: undefined, meta: _vudxzGMeta },
{ route: "/well-known", method: undefined, meta: _XoLYtKMeta },
{ route: "/__nuxt_error", method: undefined, meta: _6kTiyWMeta },
{ route: "/__nuxt_island/**", method: undefined, meta: _SxA8c9Meta },
{ route: "/__nuxt_content/:collection/sql_dump.txt", method: undefined, meta: _QSy2txMeta },
{ route: "/__nuxt_content/:collection/query", method: undefined, meta: _E76sggMeta },
{ route: "/_openapi.json", method: undefined, meta: _9Jq1pzMeta },
{ route: "/_scalar", method: undefined, meta: __SB7yHMeta },
{ route: "/_swagger", method: undefined, meta: _UiybO9Meta }
  ];

const _9Jq1pz = eventHandler((event) => {
...
const __SB7yH = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
...
const _UiybO9 = eventHandler((event) => {
  const runtimeConfig = useRuntimeConfig(event);
  const title = runtimeConfig.nitro.openAPI?.meta?.title || "API Reference";
  const description = runtimeConfig.nitro.openAPI?.meta?.description || "";
  const openAPIEndpoint = runtimeConfig.nitro.openAPI?.route || "./_openapi.json";
...
const _lazy_6kTiyW = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_6kTiyW, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/_openapi.json', handler: _9Jq1pz, lazy: false, middleware: false, method: undefined },
  { route: '/_scalar', handler: __SB7yH, lazy: false, middleware: false, method: undefined },
  { route: '/_swagger', handler: _UiybO9, lazy: false, middleware: false, method: undefined },
...
const content = defineEventHandler(async (event) => {
  ...
  try {
    ...
    const filePathsArrays = await Promise.all(dirsToRead.map((dir) => readDir$1(dir)));
