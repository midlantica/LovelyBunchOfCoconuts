    ...
    const loadMeme = async () => {
      ...
      try {
        ...
        if (found && !found.error) {
          meme.value = found;
          if (found.body) {
            let content = found.body.replace(/^---[\s\S]*?---/, "").replace(/^!\[.*?\]\(.*?\)\s*/, "").trim();
            markdownContent.value = md.render(content);
          }
        } else {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (loading.value) {
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-white text-center" data-v-ad87bf89${_scopeId}>`);
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_Icon, {
                name: "svg-spinners:90-ring-with-bg",
                size: "2rem"
              }, null, _parent2, _scopeId));
              ...
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-red-500 text-center" data-v-ad87bf89${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(error.value)}</div>`);
            } else if (meme.value) {
              _push2(`<div data-v-ad87bf89${_scopeId}><div class="flex flex-col flex-1 justify-center items-center w-full h-full" data-v-ad87bf89${_scopeId}><div class="relative flex flex-col bg-slate-800 rounded-lg w-full h-full modal-frame" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "max-width": "90vw", "max-height": "90vh", "min-width": "41vw", "height": "100%", "box-sizing": "border-box", "display": "flex", "flex-direction": "column", "align-items": "stretch", "justify-content": "flex-start", "margin": "auto" })}" data-v-ad87bf89${_scopeId}><div style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "100%", "flex-shrink": "0", "display": "flex", "align-items": "flex-start", "justify-content": "center", "padding": "0", "margin": "0" })}" data-v-ad87bf89${_scopeId}>`);
              if (meme.value.image) {
                ...
                )}" data-v-ad87bf89${_scopeId}>`);
              } else {
                _push2(`<div class="py-4 text-red-400" data-v-ad87bf89${_scopeId}>\u{1F6A8} Meme image not found!</div>`);
              }
              _push2(`</div>`);
            ...
            `)}" data-v-ad87bf89${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${(_a = getAboveHr(markdownContent.value)) != null ? _a : ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${(_b = getBelowHr(markdownContent.value)) != null ? _b : ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-ad87bf89${_scopeId}><div data-v-ad87bf89${_scopeId}>${(_c = markdownContent.value) != null ? _c : ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
              _push2(`<div class="flex flex-col justify-center items-center p-8 min-w-[10vw] min-h-[10vh]" data-v-ad87bf89${_scopeId}>`);
...
const MemeDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ad87bf89"]]);
const _sfc_main$1 = {
  __name: "MemePanel",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=index-NhvH7kMH.mjs.map
