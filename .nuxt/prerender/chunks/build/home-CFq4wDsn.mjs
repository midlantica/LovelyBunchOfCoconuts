...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    vueExports.ref(null);
    const pillClaimCount = vueExports.computed(() => {
      var _a;
      return (_a = props.claimCount) != null ? _a : 0;
    });
    const pillQuoteCount = vueExports.computed(() => {
      var _a;
      return (_a = props.quoteCount) != null ? _a : 0;
    });
    const pillMemeCount = vueExports.computed(() => {
      var _a;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "flex flex-col items-start gap-2 w-full h-auto text-seagull-950" }, _attrs))} data-v-8ac9ee62><div class="relative flex flex-row gap-0 w-full" data-v-8ac9ee62>`);
      ...
      _push(`<!--]--></div><span class="font-light text-slate-400 uppercase tracking-wider" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "1.155rem" })}" data-v-8ac9ee62>${serverRenderer_cjs_prodExports.ssrInterpolate(props.totalItemCount)}</span></div>`);
      if (searchTerm.value && props.totalCount === 0) {
        _push(`<div class="flex flex-col flex-1 justify-center items-center w-full min-h-[60vh]" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "margin-top": "3.5rem" })}" data-v-8ac9ee62><h1 class="m-auto mt-16 font-light text-white text-2xl text-center" data-v-8ac9ee62>No results found.</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=home-CFq4wDsn.mjs.map
