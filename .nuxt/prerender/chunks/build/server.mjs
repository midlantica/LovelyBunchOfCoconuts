import { inject, hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, watch, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, withCtx, getCurrentScope, nextTick, useSSRContext } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/index.mjs';
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, withBase } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
import { b as baseURL } from '../nitro/nitro.mjs';
...
import { getContext, executeAsync } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/unctx@2.4.1/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/h3@1.15.3/node_modules/h3/dist/index.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import defu$1, { defu } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/defu@6.1.4/node_modules/defu/dist/defu.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/server-renderer/index.mjs';
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-CFXtLXiP.mjs');
...
const unhead_kS686prYl1pUKpoDJsSotJ_b4o9_XTM_65YficbrGa4 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./index-DzbsUTE5.mjs')
  },
  {
    name: "memes-slug",
    path: "/memes/:slug(.*)*",
    component: () => import('./_...slug_-BNmLGKHz.mjs')
  },
  {
    name: "claims-slug",
    path: "/claims/:slug(.*)*",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./_...slug_-VB8zOWA5.mjs')
  },
  {
    name: "quotes-slug",
    path: "/quotes/:slug(.*)*",
    meta: __nuxt_page_meta || {},
    component: () => import('./_...slug_-CzKWIxlc.mjs')
  }
];
...
const redirect_45domain_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
  return;
});
...
const revive_payload_server_or8s6Ou5q3C5JDQbWzg5Ur0kPkPPFMen8b2EbSPz6eE = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-oUdncCau.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-CNhvErMP.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-topIL8Sv.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-3dfn1eag.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BOWSPjQ3.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BCSdsXjf.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BeBORM26.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-bs6VFVgM.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-3BKlw1yl.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BkpUzy_g.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Czd8ZMLe.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-DTr01boi.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-C9X_Bwdx.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-DgD6b52L.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DWfccV36.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BmYh2UAe.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-CdlH5OIN.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-BkL0i22r.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-DZvxuurb.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CloJqfBO.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-Cmeuuok6.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-3hU5OJcn.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-CB-uAuUM.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BmLm-AMX.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-DeLEKNDN.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyIcon = defineAsyncComponent(() => import('./Icon-CT7HiOLN.mjs').then((r2) => r2["default"] || r2.default || r2));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BUXmuq5s.mjs').then((r2) => r2["default"] || r2.default || r2));
...
const prerender_server_8BzR_5qKEZzVA9J8ABVYjlPYp0tVJvMDrHZb3uCGlU4 = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
  if (routes && !routes.length) {
    return;
  }
  const routeRules = (/* @__PURE__ */ useRuntimeConfig()).nitro.routeRules;
  if (routeRules && Object.values(routeRules).some((r2) => r2.prerender)) {
...
function processRoutes(routes2, currentPath = "/", routesToPrerender = /* @__PURE__ */ new Set()) {
  ...
  for (const route of routes2) {
    if (OPTIONAL_PARAM_RE.test(route.path) && !((_a2 = route.children) == null ? void 0 : _a2.length) && shouldPrerender(currentPath)) {
...
const plugins = [
  unhead_kS686prYl1pUKpoDJsSotJ_b4o9_XTM_65YficbrGa4,
  plugin,
  revive_payload_server_or8s6Ou5q3C5JDQbWzg5Ur0kPkPPFMen8b2EbSPz6eE,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  prerender_server_8BzR_5qKEZzVA9J8ABVYjlPYp0tVJvMDrHZb3uCGlU4
];
const layouts = {
  "content-detail": defineAsyncComponent(() => import('./content-detail-CBXDdiuL.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-PmhL1Dhl.mjs').then((m) => m.default || m)),
  home: defineAsyncComponent(() => import('./home-w8ArmWxj.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    useError();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col justify-center items-center px-4 py-16 min-h-screen text-white" }, _attrs))}><div class="text-center"><h1 class="mb-4 font-light text-4xl">Page Not Found</h1><p class="mb-8 text-xl">The page you&#39;re looking for doesn&#39;t exist or has been moved.</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.5_@parcel+watcher@2.5.1_@types+node@24.0.4_better-sqlite3@12.1.1_db0@0.3.2_be_8a0cca195336401e66eaa2569f61a0cc/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Yr as Y, Zt as Z, useRouter as a, useRouter$1 as b, useNuxtApp as c, useRuntimeConfig as d, entry$1 as default, nuxtLinkDefaults as e, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
