...
import { u as useContentFeed } from './useContentFeed-BYnw4BX3.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
import 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/lodash-es@4.17.21/node_modules/lodash-es/lodash.js';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      serverRenderer_cjs_prodExports.ssrRenderTeleport(_push, (_push2) => {
        if (__props.show) {
          _push2(`<div class="z-50 fixed inset-0 flex justify-center items-center bg-black/80 modal-overlay"><div class="relative flex flex-col bg-slate-800 shadow-lg mx-6 rounded-lg min-w-[60vw] max-w-[500px] modal-frame" style="${serverRenderer_cjs_prodExports.ssrRenderStyle(__props.modalStyle ? __props.modalStyle : { maxHeight: "90vh", padding: "1rem 1.75rem" })}">`);
          _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_CloseButton, { onClick: onClose }, null, _parent));
          _push2(`<div class="w-full overflow-y-auto">`);
          serverRenderer_cjs_prodExports.ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent);
          _push2(`</div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
...
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const markdownContent = vueExports.ref("");
    ...
    const loadClaim = async () => {
      ...
      try {
        ...
        if (found && !found.error) {
          ...
          error.value = (found == null ? void 0 : found.message) || "\u{1F6A8} Claim not found!";
        }
      } catch (err) {
    ...
    vueExports.watch(() => props.slug, loadClaim, { immediate: true });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$1;
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        show: __props.show,
        onClose: close
      }, _attrs), {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (loading.value) {
              ...
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-red-500 text-center" data-v-ab5156c2${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(error.value)}</div>`);
            } else if (claim.value) {
              _push2(`<div class="flex flex-col flex-1 min-h-0" data-v-ab5156c2${_scopeId}><div class="pb-2" data-v-ab5156c2${_scopeId}><div class="prose-invert max-w-none prose prose-lg" data-v-ab5156c2${_scopeId}><div data-v-ab5156c2${_scopeId}>${(_a = markdownContent.value) != null ? _a : ""}</div></div></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
            ...
            return [
              vueExports.createVNode("div", { class: "flex flex-col w-full overflow-y-auto" }, [
                vueExports.createVNode("div", { class: "flex-1 min-h-0 overflow-y-auto" }, [
                  loading.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                    key: 0,
                  ...
                  ])) : error.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                    key: 1,
                    class: "flex flex-1 justify-center items-center py-8 text-red-500 text-center"
                  }, vueExports.toDisplayString(error.value), 1)) : claim.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                    key: 2,
                    class: "flex flex-col flex-1 min-h-0"
                  }, [
                    vueExports.createVNode("div", { class: "pb-2" }, [
                      vueExports.createVNode("div", { class: "prose-invert max-w-none prose prose-lg" }, [
                        vueExports.createVNode("div", { innerHTML: markdownContent.value }, null, 8, ["innerHTML"])
                      ])
                    ])
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    const showModal = vueExports.ref(false);
    const closeModal = () => showModal.value = false;
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.claim && __props.claim.claim && __props.claim.translation && __props.slug) {
        _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "flex flex-col gap-2 bg-slate-800 hover:bg-slate-900 shadow-[inset_0_0_12px_0_#0f1e24] px-4 py-3 border hover:border hover:border-seagull-400 border-transparent rounded-lg h-full text-white transition-colors cursor-pointer" }, _attrs))}><div class="my-auto"><div class="flex items-center gap-3"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_0)} alt="NPC" class="w-8"><h2 class="font-light text-xl line-clamp-1 tracking-wide">${serverRenderer_cjs_prodExports.ssrInterpolate(__props.claim.claim)}</h2></div><hr class="my-2 border-white/10 border-t"><div class="flex items-center gap-3"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_1)} alt="Player" class="w-8">`);
        if (__props.claim.translation) {
          _push(`<h2 class="font-light text-xl line-clamp-1 tracking-wide">${serverRenderer_cjs_prodExports.ssrInterpolate(__props.claim.translation)}</h2>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
        if (showModal.value) {
          _push(serverRenderer_cjs_prodExports.ssrRenderComponent(ClaimDetailModal, {
            slug: __props.slug,
        ...
        _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "flex flex-col gap-2 bg-slate-800 shadow-[inset_0_0_12px_0_#0f1e24] px-4 py-3 rounded-lg h-full text-white" }, _attrs))}><div class="my-auto"><div class="flex items-center gap-3"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_0)} alt="NPC" class="w-8"><h2 class="line-clamp-1">${serverRenderer_cjs_prodExports.ssrInterpolate(__props.claim && __props.claim.claim ? __props.claim.claim : "Missing claim")}</h2></div><hr class="my-2 border-white/10 border-t"><div class="flex items-center gap-3"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", _imports_1)} alt="Player" class="w-8">`);
        if (__props.claim && __props.claim.translation) {
          _push(`<h2 class="line-clamp-1">${serverRenderer_cjs_prodExports.ssrInterpolate(__props.claim.translation)}</h2>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div></div>`);
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const loading = vueExports.ref(true);
    const markdownContent = vueExports.ref("");
    const quoteBodyHtml = vueExports.ref("");
    const { getContentItem } = useContentCache();
    ...
    const loadQuote = async () => {
      ...
      try {
        ...
        if (found && !found.error) {
          ...
          error.value = (found == null ? void 0 : found.message) || "\u{1F6A8} Quote not found!";
        }
      } catch (err) {
        error.value = err.message;
      } finally {
    ...
    vueExports.watch(() => props.slug, loadQuote, { immediate: true });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$1;
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        show: __props.show,
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (loading.value) {
              ...
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-red-500 text-center"${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(error.value)}</div>`);
            } else if (quote.value) {
            ...
            return [
              loading.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                ...
                key: 1,
                class: "flex flex-1 justify-center items-center py-8 text-red-500 text-center"
              }, vueExports.toDisplayString(error.value), 1)) : quote.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                key: 2,
                class: "flex flex-col flex-1 min-h-0"
              }, [
                vueExports.createVNode("div", { class: "pb-2" }, [
                  vueExports.createVNode("div", { class: "prose-invert max-w-none text-left prose prose-sm" }, [
                    vueExports.createVNode("div", { innerHTML: quoteBodyHtml.value }, null, 8, ["innerHTML"])
                  ]),
                  quote.value.attribution ? (vueExports.openBlock(), vueExports.createBlock("p", {
                    key: 0,
                    class: "mt-2 font-light text-seagull-200 text-lg"
                  }, " \u2014 " + vueExports.toDisplayString(quote.value.attribution), 1)) : vueExports.createCommentVNode("", true)
                ]),
                markdownContent.value.split("<hr>")[1] && markdownContent.value.split("<hr>")[1].trim() ? (vueExports.openBlock(), vueExports.createBlock(vueExports.Fragment, { key: 0 }, [
                  vueExports.createVNode("hr", { class: "my-2 border-white/10 border-t" }),
                  vueExports.createVNode("div", {
                    class: "flex-1 bg-slate-800 py-2 rounded-b-lg min-h-0 overflow-y-auto",
                    style: { "max-height": "40vh" }
                  }, [
                    vueExports.createVNode("div", { class: "prose-invert max-w-none text-seagull-200 prose prose-sm" }, [
                      vueExports.createVNode("div", {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.quote && __props.quote.headings && __props.quote.headings.length > 0 && __props.slug) {
        ...
        if (__props.quote.attribution) {
          _push(`<p class="inline-block font-light text-seagull-200 text-lg align-baseline tracking-wide"> \u2014 ${serverRenderer_cjs_prodExports.ssrInterpolate(__props.quote.attribution)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        ...
        _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "flex flex-col gap-2 bg-slate-800 shadow-[inset_0_0_12px_0_#0f1e24] px-5 py-4 rounded-lg text-white quotePanel" }, _attrs))}><div class="my-auto"><h2 class="inline-block align-baseline">${serverRenderer_cjs_prodExports.ssrInterpolate(__props.quote && __props.quote.headings && __props.quote.headings.length > 0 ? `\u201C${__props.quote.headings[0]}\u201D` : "\u{1F6A8} No quote found!")}</h2>`);
        if (__props.quote && __props.quote.attribution) {
          _push(`<p class="inline-block font-light text-seagull-200 text-lg align-baseline"> \u2014 ${serverRenderer_cjs_prodExports.ssrInterpolate(__props.quote.attribution)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
...
function useModalLogic({ show, onClose }) {
  const isOpen = vueExports.ref(show);
  return {
    isOpen,
    close: onClose
  };
...
function useModalSizing(imageUrlRef) {
  const imageNatural = vueExports.ref({ width: 1, height: 1 });
  const viewport = vueExports.ref({ width: 0, height: 0 });
  const aspect = vueExports.computed(() => {
    const w = imageNatural.value.width;
    const h = imageNatural.value.height;
    return w / h;
  });
  const modalLayout = vueExports.computed(() => {
    return {
      width: "90vw",
      height: "90vh",
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit = __emit;
    const meme = vueExports.ref(null);
    const error = vueExports.ref(null);
    const loading = vueExports.ref(true);
    const markdownContent = vueExports.ref("");
    const isLandscape = vueExports.ref(false);
    const { getContentItem } = useContentCache();
    const md = new MarkdownIt({ html: true, linkify: true, typographer: true });
    const close = () => emit("close");
    useModalLogic({ show: props.show, onClose: close });
    vueExports.computed(() => meme.value && meme.value.image ? meme.value.image : "");
    ...
    const loadMeme = async () => {
      ...
      try {
        ...
        if (found && !found.error) {
          ...
          error.value = (found == null ? void 0 : found.message) || "\u{1F6A8} Meme not found!";
        }
      } catch (err) {
        error.value = err.message;
      } finally {
    ...
    const modalFrameStyle = vueExports.computed(() => {
    ...
    vueExports.watch(() => props.slug, loadMeme, { immediate: true });
    const hasExtraText = vueExports.computed(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_sfc_main$7, vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (loading.value) {
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-white text-center" data-v-d6cb9f97${_scopeId}>`);
              _push2(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_Icon, {
                name: "svg-spinners:90-ring-with-bg",
                size: "2rem"
              }, null, _parent2, _scopeId));
              ...
              _push2(`<div class="flex flex-1 justify-center items-center py-8 text-red-500 text-center" data-v-d6cb9f97${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(error.value)}</div>`);
            } else if (meme.value) {
              _push2(`<div data-v-d6cb9f97${_scopeId}><div class="flex flex-col flex-1 justify-center items-center w-full h-full" data-v-d6cb9f97${_scopeId}><div class="relative flex flex-col bg-slate-800 rounded-lg w-full h-full modal-frame" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "max-width": "90vw", "max-height": "90vh", "min-width": "41vw", "height": "100%", "box-sizing": "border-box", "display": "flex", "flex-direction": "column", "align-items": "stretch", "justify-content": "flex-start", "margin": "auto" })}" data-v-d6cb9f97${_scopeId}><div style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "width": "100%", "flex-shrink": "0", "display": "flex", "align-items": "flex-start", "justify-content": "center", "padding": "0", "margin": "0" })}" data-v-d6cb9f97${_scopeId}>`);
              if (meme.value.image) {
                _push2(`<img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", meme.value.image)}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", meme.value.title || "Meme")} class="${serverRenderer_cjs_prodExports.ssrRenderClass([!isLandscape.value ? "meme-modal-img-column" : "", "rounded object-contain"])}" style="${serverRenderer_cjs_prodExports.ssrRenderStyle(
                ...
                _push2(`<div class="py-4 text-red-400" data-v-d6cb9f97${_scopeId}>\u{1F6A8} Meme image not found!</div>`);
              }
              _push2(`</div>`);
            ...
            `)}" data-v-d6cb9f97${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-d6cb9f97${_scopeId}><div data-v-d6cb9f97${_scopeId}>${(_a = getAboveHr(markdownContent.value)) != null ? _a : ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-d6cb9f97${_scopeId}><div data-v-d6cb9f97${_scopeId}>${(_b = getBelowHr(markdownContent.value)) != null ? _b : ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-d6cb9f97${_scopeId}><div data-v-d6cb9f97${_scopeId}>${(_c = markdownContent.value) != null ? _c : ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
              _push2(`<div class="flex flex-col justify-center items-center p-8 min-w-[10vw] min-h-[10vh]" data-v-d6cb9f97${_scopeId}>`);
            ...
            return [
              loading.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                ...
                key: 1,
                class: "flex flex-1 justify-center items-center py-8 text-red-500 text-center"
              }, vueExports.toDisplayString(error.value), 1)) : meme.value ? (vueExports.openBlock(), vueExports.createBlock("div", { key: 2 }, [
                vueExports.createVNode("div", { class: "flex flex-col flex-1 justify-center items-center w-full h-full" }, [
                  vueExports.createVNode("div", {
                    ...
                    vueExports.createVNode("div", { style: { "width": "100%", "flex-shrink": "0", "display": "flex", "align-items": "flex-start", "justify-content": "center", "padding": "0", "margin": "0" } }, [
                      meme.value.image ? (vueExports.openBlock(), vueExports.createBlock("img", {
                        key: 0,
                      ...
                      }, null, 14, ["src", "alt"])) : (vueExports.openBlock(), vueExports.createBlock("div", {
                        key: 1,
                        class: "py-4 text-red-400"
                      }, "\u{1F6A8} Meme image not found!"))
                    ]),
                    hasExtraText.value ? (vueExports.openBlock(), vueExports.createBlock("div", {
                      key: 0,
                      class: [
                        "flex flex-1 items-stretch w-full text-slate-200",
                        isLandscape.value ? "flex-row gap-4" : "flex-col"
            ...
            `
                    ...
                    ], 6)) : (vueExports.openBlock(), vueExports.createBlock("div", {
                      key: 1,
                      class: "prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base",
...
const MemeDetailModal = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d6cb9f97"]]);
const _sfc_main$1 = {
  __name: "MemePanel",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.meme && __props.meme.image && __props.slug) {
        _push(`<div class="block bg-slate-800 hover:bg-slate-900 shadow-[inset_0_0_12px_0_#0f1e24] mx-auto p-3 border hover:border hover:border-seagull-400 border-transparent rounded-lg w-full h-full overflow-hidden cursor-pointer"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", __props.meme.image)} alt="Meme" class="bg-black/40 rounded-lg w-full h-full object-contain aspect-square" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "max-width": "100%", "max-height": "100%", "min-width": "0", "min-height": "0" })}"></div>`);
      } else if (__props.meme && __props.meme.image) {
        _push(`<div class="block bg-slate-800 shadow-[inset_0_0_12px_0_#0f1e24] mx-auto p-3 rounded-lg w-full h-full overflow-hidden"><img${serverRenderer_cjs_prodExports.ssrRenderAttr("src", __props.meme.image)} alt="Meme" class="bg-black/40 rounded-lg w-full h-full object-contain aspect-square" style="${serverRenderer_cjs_prodExports.ssrRenderStyle({ "max-width": "100%", "max-height": "100%", "min-width": "0", "min-height": "0" })}"></div>`);
      } else {
      ...
      if (showModal.value) {
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(MemeDetailModal, {
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const searchTerm = vueExports.inject("searchTerm", vueExports.ref(""));
    const contentFilters = vueExports.inject("contentFilters", vueExports.ref({ claims: true, quotes: true, memes: true }));
    ...
    vueExports.computed(() => claimCount.value + quoteCount.value + memeCount.value);
    vueExports.ref(null);
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0$1;
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "grid grid-cols-1 w-full" }, _attrs))}><div id="modal-root"></div>`);
      if (vueExports.unref(error)) {
        _push(`<div class="text-red-500">Error loading content: ${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(error).message)}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (vueExports.unref(displayedItems).length) {
        _push(`<section class="gap-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 auto-rows-min"><!--[-->`);
        serverRenderer_cjs_prodExports.ssrRenderList(vueExports.unref(displayedItems), (item, index) => {
          var _a;
          ...
          if (item.type === "claimPair") {
            ...
            serverRenderer_cjs_prodExports.ssrRenderList(item.data, (claimItem, idx) => {
              var _a2;
              _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_ClaimTranslationPanel, {
                key: idx,
            ...
            _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_QuotePanel, {
              quote: item.data,
              slug: ((_a = item.data) == null ? void 0 : _a._path) || ""
            }, null, _parent));
          } else if (item.type === "memeRow") {
            _push(`<div class="gap-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2"><!--[-->`);
            serverRenderer_cjs_prodExports.ssrRenderList(item.data, (memeItem, idx) => {
              var _a2;
              _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_MemePanel, {
                key: idx,
                meme: memeItem.data,
        ...
        _push(`<!--]--></section>`);
      } else if (vueExports.unref(loading)) {
        ...
        _push(`<div class="flex flex-col justify-center items-center min-h-[60vh]"><h1 class="font-light text-white text-2xl text-center">${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(searchTerm) ? "No results found." : !vueExports.unref(contentFilters).claims && !vueExports.unref(contentFilters).quotes && !vueExports.unref(contentFilters).memes ? "No content found. Select a category above." : "No content found.")}</h1></div>`);
      }
      if (vueExports.unref(loading) && vueExports.unref(displayedItems).length) {
        _push(`<div class="flex flex-col justify-center justify-self-center content-center place-content-center self-center place-items-center gap-4 py-4 text-white text-center align-center">`);
        _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_Icon, {
          name: "svg-spinners:90-ring-with-bg",
          size: "1.75rem"
...
//# sourceMappingURL=index-DAfdpj1i.mjs.map
