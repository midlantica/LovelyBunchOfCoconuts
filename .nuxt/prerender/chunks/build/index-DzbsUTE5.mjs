import { inject, ref, computed, mergeProps, unref, watch, withCtx, createBlock, createCommentVNode, openBlock, createVNode, toDisplayString, Fragment, renderSlot, useSSRContext } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrRenderStyle, ssrRenderTeleport, ssrRenderSlot, ssrRenderClass } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/vue@3.5.17_typescript@5.8.3/node_modules/vue/server-renderer/index.mjs';
...
import { withoutTrailingSlash } from 'file:///Users/drew/Documents/_work/WakeUpNPC2/node_modules/.pnpm/ufo@1.6.1/node_modules/ufo/dist/index.mjs';
    ...
    const loadMeme = async () => {
      ...
      try {
        ...
        if (found.length > 0) {
          ...
          error.value = "\u{1F6A8} Meme not found!";
        }
      } catch (err) {
        error.value = err.message;
      } finally {
          ...
          if (_push2) {
            if (loading.value) {
              ...
              if (meme.value.image) {
                ...
                _push2(`<div class="py-4 text-red-400" data-v-bf2c896e${_scopeId}>\u{1F6A8} Meme image not found!</div>`);
              }
              _push2(`</div>`);
            ...
            `)}" data-v-bf2c896e${_scopeId}><div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%", "margin-bottom": "1rem" })}" data-v-bf2c896e${_scopeId}><div data-v-bf2c896e${_scopeId}>${(_a = getAboveHr(markdownContent.value)) != null ? _a : ""}</div></div><div class="bg-slate-800 w-full min-h-0 text-slate-200 shrink modal-scrollable-text" style="${ssrRenderStyle({ "overflow-y": "auto", "max-height": "100%", "width": "100%" })}" data-v-bf2c896e${_scopeId}><div data-v-bf2c896e${_scopeId}>${(_b = getBelowHr(markdownContent.value)) != null ? _b : ""}</div></div></div>`);
              } else {
                _push2(`<div class="prose-invert mx-auto pt-2 w-full text-center shrink prose prose-base" style="${ssrRenderStyle({ "font-size": "clamp(1rem, 2vw, 1.5rem)", "width": "100%" })}" data-v-bf2c896e${_scopeId}><div data-v-bf2c896e${_scopeId}>${(_c = markdownContent.value) != null ? _c : ""}</div></div>`);
              }
              _push2(`</div></div></div>`);
            } else {
...
//# sourceMappingURL=index-DzbsUTE5.mjs.map
